...
# GET /api/videos/:hashPrefix — no matching videos (valid prefix, no data)
echo "GET /api/videos/:hashPrefix — no matches"
do_request GET "$BASE_URL/api/videos/zzzzzzzz"
...
# GET /api/videos?videoId=nonexistent — not found
echo "GET /api/videos?videoId=nonexistent"
do_request GET "$BASE_URL/api/videos?videoId=nonexistent_video_12345"
